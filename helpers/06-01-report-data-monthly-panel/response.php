<?php
function html_loading_data($_dates, $dates, $area_machine_tags)
{
    $html = <<<HTML
        <caption style="display: none">
            <b style="background-color: #8FE40F; text-align:center" ><h3>DAILY REPORT</h3></b> 
        </caption>
        <tbody>
            <tr>
                <td>AREA</td>

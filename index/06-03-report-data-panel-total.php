								...
								<div class="row">
									<div class="col-12 col-sm-4 ">
										...
										<label class="form-selectgroup-item">
											...
											<span class="form-selectgroup-label">ELECTRIC PANEL - Report by Month, Yearly</span>
										</label>
									</div>
									<div class="col-12 col-sm-3 ">
										<label class="form-label" style="color:#000000;">Choose Year</label>
										<div class="input-icon mb-2">
											...
											<input class="form-control " placeholder="Input year" id="datepicker-year" value="<?php echo date("Y"); ?>" type="number" placeholder="YYYY" min="1999" max="2999"/>
										</div>
									</div>
...
function Click_Function(){
	var year = parseInt($('#datepicker-year').val(), 10);
	
	if(Number.isInteger(year))
	{
		var factory	= "SOLUM";
		var machine	= "ELECTRIC_PANEL";
		loading_data(factory,machine,year);
	}
	else{
...
function loading_data(factory,machine,year)
{	
	if (currentRequest) {
	...
	currentRequest = $.ajax({
		type: "POST",
		url: "sql/06-03-report-data-total-panel.php",
		data: {act:'select',factory:factory,machine:machine,year:year},
		cache: false,
